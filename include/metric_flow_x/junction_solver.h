#ifndef METRIC_FLOW_X_JUNCTION_SOLVER_H
#define METRIC_FLOW_X_JUNCTION_SOLVER_H
...
namespace MetricFlowX
{
  ...
  // So for face 0 it is -1 and for face 1 it is +1. This way we can easily
  // write the mass conservation as sum(s_i * A_i * U_i) = 0 where s_i is the
  // orientation.
