...
#ifndef METRIC_FLOW_X_PARSED_TOOLS_CONSTANTS_H
#define METRIC_FLOW_X_PARSED_TOOLS_CONSTANTS_H
...
namespace MetricFlowX
{
  ...
  {
    /**
     * A wrapper for physical constants to be shared among functions and
     * classes.
     *
     ...
     *
     * Constants given at construction time takes precedence, so if you use "E"
     * as a constant name, than that value will be used instead of the Nepero
     * constant numbers::E.
     */
    ...
    public:
       ...
       * @p optional_names_for_parameter_file empty would result in the
       * following parameter entries:
       * @code{.sh}
       * subsection Physical Constants
       *   set a = 1.0
       *   set b = 2.0
    ...
    private:
      ...
      /**
       * The documentation string used to parse the constants from thee
       * parameter file.
       */
